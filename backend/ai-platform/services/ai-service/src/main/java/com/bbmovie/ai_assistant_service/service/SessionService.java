...
public interface SessionService {
     ...
     */
    Mono<ChatSession> getAndValidateSessionOwnership(UUID sessionId, UUID userId);
     ...
     * @return A Mono emitting the updated session DTO.
     */
    Mono<ChatSessionResponse> setSessionArchived(UUID sessionId, UUID userId, boolean isArchived);
