...
public class ExperimentalStreamingChatController {
    ...
    public Flux<String> streamChat(@RequestBody ChatRequest request, @AuthenticationPrincipal String principal) {
        return streamingUserAssistant.chat(request.getSessionId(), request.getMessage(), principal)
