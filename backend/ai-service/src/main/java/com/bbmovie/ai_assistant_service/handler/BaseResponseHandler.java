...
public abstract class BaseResponseHandler implements StreamingChatResponseHandler {
     ...
     */
    protected final FluxSink<ChatStreamChunk> sink;
     ...
     */
    protected BaseResponseHandler(FluxSink<ChatStreamChunk> sink, MonoSink<Void> monoSink) {
        this.sink = sink;
    ...
    protected void handleThinking(ChatResponse chatResponse) {
        ...
        String sanitizedThinking = ThinkingSanitizer.sanitize(thinking);
    ...
    public void onPartialResponse(String partialResponse) {
        ...
        sink.next(ChatStreamChunk.assistant(partialResponse));
    }
