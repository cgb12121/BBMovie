 ...
 */
@Component
public class _ChatSessionRepositoryCustomImpl implements _ChatSessionRepositoryCustom {

    private final R2dbcEntityOperations r2dbcOperations;

    @Autowired
    public _ChatSessionRepositoryCustomImpl(@Qualifier("_EntityOperations") R2dbcEntityOperations r2dbcOperations) {
        this.r2dbcOperations = r2dbcOperations;
    }

    @Override
    public Flux<_ChatSession> findActiveSessionsWithCursor(UUID userId, Instant cursorTime, int limit) {
    ...
    @Override
    public Flux<_ChatSession> findArchivedSessionsWithCursor(UUID userId, Instant cursorTime, int limit) {
