...
public final class AnsiRainbowUtil {
    ...
    public static String getFullRainbow(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getFullRgbColor, false);
    }
    ...
    public static String getFullRainbowUnderlined(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getFullRgbColor, true);
    }
    ...
    public static String getLightRainbow(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getLightRgbColor, false);
    }
    ...
    public static String getLightRainbowUnderlined(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getLightRgbColor, true);
    }
    ...
    public static String getErrorLightRed(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getErrorRgb, false);
    }
    ...
    public static String getErrorLightRedUnderlined(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getErrorRgb, true);
    }
    ...
    public static String getWarningOrangeToYellow(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getWarningRgb, false);
    }
    ...
    public static String getWarningOrangeToYellowUnderlined(String text) {
        return buildRainbowString(text, AnsiRainbowUtil::getWarningRgb, true);
    }
