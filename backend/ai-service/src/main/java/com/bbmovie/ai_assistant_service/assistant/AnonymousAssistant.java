...
@Component
public class AnonymousAssistant extends BaseAssistant {

    private final ChatResponseHandlerFactory handlerFactory;

    @Autowired
    public AnonymousAssistant(
            ...
            @Qualifier("simpleHandlerFactory") ChatResponseHandlerFactory handlerFactory,
            MessageServiceImpl chatMessageService,
    ...
    public AssistantType getType() {
        return AssistantType.ANONYMOUS;
    }
