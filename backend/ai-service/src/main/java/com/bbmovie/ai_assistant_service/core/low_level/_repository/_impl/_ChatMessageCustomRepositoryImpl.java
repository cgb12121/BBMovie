...
import com.bbmovie.ai_assistant_service.core.low_level._repository._ChatMessageCustomRepository;
...
@Component
public class _ChatMessageCustomRepositoryImpl implements _ChatMessageCustomRepository {

    private final R2dbcEntityOperations r2dbcOperations;

    @Autowired
    public _ChatMessageCustomRepositoryImpl(@Qualifier("_EntityOperations") R2dbcEntityOperations r2dbcOperations) {
        this.r2dbcOperations = r2dbcOperations;
    }

    @Override
    public Flux<_ChatMessage> getWithCursor(UUID sessionId, Instant cursorTime, int size) {
