...
public class SpeedSMSAPI {
	...
	public String sendSMS(String to, String content, int type, String sender) throws IOException, URISyntaxException {
		String json = "{\"to\": [\"" + to + "\"], \"content\": \"" + encodeNonAsciiCharacters(content) + "\", \"type\":" + type + ", \"BBMOVIE\":\"" + sender + "\"}";
		URL url = new URI(API_URL + "/sms/send").toURL();
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
