...
public class VnpayQueryParams {
    ...
    public static final String VNPAY_AMOUNT_PARAM = "vnp_Amount";
    public static final String VNPAY_CURRENCY_PARAM = "vnp_CurrCode";
    public static final String VNPAY_TXN_REF_PARAM = "vnp_TxnRef";
    public static final String VNPAY_ORDER_INFO_PARAM = "vnp_OrderInfo";
    public static final String VNPAY_ORDER_TYPE_PARAM = "vnp_OrderType";
    public static final String VNPAY_LOCALE_PARAM = "vnp_Locale";
