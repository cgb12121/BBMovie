...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentVerificationResponse>> handleProviderCallbackGet(
        ...
        PaymentVerificationResponse verification = paymentService.verifyPayment(provider, params, request);
    ...
    public ResponseEntity<Map<String, String>> handleProviderCallbackPost(
        ...
        PaymentVerificationResponse verification = paymentService.verifyPayment("zalopay", body, request);
