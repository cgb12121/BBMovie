...
enum class VnPayTransactionStatus(val code: String, val message: String) {
    ...
    companion object {
        fun fromCode(code: String): VnPayTransactionStatus? =
            VnPayTransactionStatus.entries.find { it.code == code }
    }
}