...
public interface MediaProcessor {
    ...
    record ProcessingResult(
        ...
        public static ProcessingResult success(Double duration, String outputPath) {
            return new ProcessingResult(duration, outputPath, true, null, null, null, null);
        }
        ...
        public static ProcessingResult success(
                ...
                Integer sourceWidth,
                Integer sourceHeight) {
            return new ProcessingResult(duration, outputPath, true, null, availableResolutions, sourceWidth, sourceHeight);
        }

        public static ProcessingResult success(String outputPath) {
            return new ProcessingResult(null, outputPath, true, null, null, null, null);
        }

        public static ProcessingResult failure(String errorMessage) {
            return new ProcessingResult(null, null, false, errorMessage, null, null, null);
        }
    }
}
